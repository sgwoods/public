...
printf '\nNext intended phase:\n'
printf -- '- Add stronger SEI staff or institute context that explicitly names Steven Woods\n'
printf -- '- Extend the SEI paper and publication floor beyond the first seeded paper\n'
