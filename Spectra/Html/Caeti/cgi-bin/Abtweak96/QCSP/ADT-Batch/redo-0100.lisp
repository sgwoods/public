...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.2"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.3"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.4"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.5"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.6"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.7"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.8"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.9"
	   ))
...
(time (adt 
	   ...
	   :output-file "ADT-Batch/redo-0100-out.99"
	   ))
:exit
