...
(((_has-influence_ Result ?A ?E) AND ;?E is a complete list of effects
  ((_has-non-empty-intersection-with_ ?E ?G) AND ;proc-attach or induc rules
...
;; Note that ?E contains effects matching some goals, effects matching the negation
;;  of some goals, and effects desirable or undesirable by default.  Effects
;;  which match or counteract goals get their desirability values from parsed/
;;  inferred user input.
