...
;; This is a test of whether the system works correctly with a MORE
;;  COMPLETE rule and fact base than that used in quil1-test.lisp.

;;(load "~sgwoods/Html/Caeti/cgi-bin/Abtweak96/Pautler/Infer/infer-utils.fasl")
;;(load "~sgwoods/Html/Caeti/cgi-bin/Abtweak96/Pautler/UM/Quil1/quil1.fasl")
